public class SList{
	...
	//nth() returns the item at the specified position. 
	//If position < 1 or position > this.length(), null
	// is returned. Otherwise, the item at postion "position"
	// is returned.
	...
	//main() runs test case on the SList class.
	public static void main(String[]args){
		...
		newList.insertEnd(new Integer("10"));
